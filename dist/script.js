...
class PadKey extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("button", { className: "drum-pad", id: this.props.id, onClick: this.playSound, style: this.state.style }, /*#__PURE__*/
      React.createElement("audio", { className: "clip", id: this.props.keyTrigger, src: this.props.src }),
...
class DrumPads extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("div", { id: "keyboard" }, /*#__PURE__*/
      React.createElement(KeyBoard, { updateDisplay: this.displayClipName })), /*#__PURE__*/

      React.createElement("div", { id: "display" }, /*#__PURE__*/
      React.createElement("p", { id: "display-title" }, "Selected sound"), /*#__PURE__*/
      React.createElement("p", { id: "display-value" }, this.state.displayKey))));
...
$(document).ready(function () {
  ReactDOM.render( /*#__PURE__*/React.createElement(DrumPads, null), document.getElementById('app'));
});
// $(document).ready(function () {
